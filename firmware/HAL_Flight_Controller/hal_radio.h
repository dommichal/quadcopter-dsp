...
typedef void (*HAL_RADIO_OnReceiveComplete)(const uint8_t *data, uint8_t len);
typedef void (*HAL_RADIO_OnRequestReceived)(void);

void HAL_RADIO_init(HAL_RADIO_OnReceiveComplete onReceiveComplete,
                    HAL_RADIO_OnRequestReceived OnRequestReceived);
